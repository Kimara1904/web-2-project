...
namespace Web_2_Online_Shop.Migrations
{
    ...
    [Migration("20230521124402_IsCancledMigration")]
    partial class IsCancledMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web_2_Online_Shop.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Password = "AQAAAAEAACcQAAAAEBCbGQEWR0dDGDTkMf0E2LLFEq8Z4o+BSjmCVsLkAWe5cF0TSngt+V3mmXDIf3aLLg==",
                            Role = "Admin",
                            Username = "Admin",
                            Verified = "Accepted"
                        });
