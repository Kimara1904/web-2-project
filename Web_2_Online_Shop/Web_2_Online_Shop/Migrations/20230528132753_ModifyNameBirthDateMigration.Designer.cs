...
namespace Web_2_Online_Shop.Migrations
{
    ...
    [Migration("20230528132753_ModifyNameBirthDateMigration")]
    partial class ModifyNameBirthDateMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web_2_Online_Shop.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAEAACcQAAAAEK8ZEBjNLnxrITkTOnWRTP+DZiYPWv4Jz054G2WhrU8032wio9ByI/yrBXkY1KF+3A==",
                            Role = "Admin",
                            Username = "Admin",
                            Verified = "Accepted"
                        });
